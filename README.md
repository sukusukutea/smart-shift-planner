...
シフト自動化アプリを活用することで、少しでも業務の効率化により管理者の負担を減らす一助になればと願い、  
卒業制作アプリにしたいと思いました。  
...
## ユーザーの獲得について
元職場内での課題解決が目的のため、積極的な外部のユーザー獲得は目指していません。
...
### 【MVPリリース】
#### フェーズ１
基本設定と条件をもとにシフト作成でき、最小限のアラート表示、手動修正による半自動化を目指す
- 管理者ログイン機能
- 各種設定・登録機能
  - 職員情報登録
    - 職種：看護師、介護士、栄養士
...
- 使用予定のライブラリ
 ...
 - UI用 : gem 'bootstrap' 
 - 制約充足問題に対応 : gem 'or-tools'
 - 手動修正時にリアルタイムで更新 : Hotwire（Turbo + Stimulus）：
 - 祝日判定 : gem 'holidays'
 - Excelへのインポート用 : gem 'roo'
